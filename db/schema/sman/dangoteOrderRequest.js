...
// No live counterpart — see dangoteProduct.js.
const dangoteOrderRequests = smanSchema.table(
  "dangote_order_requests",
  {
    ...
    licenseId: bigint("license_id", { mode: "number" }).references(() => customerLicenses.id, {
      onDelete: "set null",
    }),
