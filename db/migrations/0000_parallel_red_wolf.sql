CREATE TYPE "public"."admin_role" AS ENUM('admin', 'super_admin', 'product_officer', 'audit_officer', 'it_compliance_officer', 'security_exit_officer', 'commission_officer', 'sales_manager');--> statement-breakpoint
...
ALTER TABLE "depot_staff" ADD CONSTRAINT "depot_staff_admin_id_admins_id_fk" FOREIGN KEY ("admin_id") REFERENCES "public"."admins"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "pfis" ADD CONSTRAINT "pfis_audit_officer_id_admins_id_fk" FOREIGN KEY ("audit_officer_id") REFERENCES "public"."admins"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "pfis" ADD CONSTRAINT "pfis_product_officer_id_admins_id_fk" FOREIGN KEY ("product_officer_id") REFERENCES "public"."admins"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "pfis" ADD CONSTRAINT "pfis_it_compliance_officer_id_admins_id_fk" FOREIGN KEY ("it_compliance_officer_id") REFERENCES "public"."admins"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "pfis" ADD CONSTRAINT "pfis_security_exit_officer_id_admins_id_fk" FOREIGN KEY ("security_exit_officer_id") REFERENCES "public"."admins"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "pfis" ADD CONSTRAINT "pfis_commission_officer_id_admins_id_fk" FOREIGN KEY ("commission_officer_id") REFERENCES "public"."admins"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "pfis" ADD CONSTRAINT "pfis_sales_manager_id_admins_id_fk" FOREIGN KEY ("sales_manager_id") REFERENCES "public"."admins"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "tickets" ADD CONSTRAINT "tickets_redeemed_by_admins_id_fk" FOREIGN KEY ("redeemed_by") REFERENCES "public"."admins"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "deposits" ADD CONSTRAINT "deposits_recorded_by_admins_id_fk" FOREIGN KEY ("recorded_by") REFERENCES "public"."admins"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "delivery_customers" ADD CONSTRAINT "delivery_customers_created_by_admins_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."admins"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "delivery_notes" ADD CONSTRAINT "delivery_notes_created_by_admins_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."admins"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "admins_refresh_token_idx" ON "admins" USING btree ("refresh_token");--> statement-breakpoint
...
CREATE UNIQUE INDEX "depot_staff_unique_idx" ON "depot_staff" USING btree ("depot_id","admin_id");--> statement-breakpoint
CREATE INDEX "depot_staff_depot_idx" ON "depot_staff" USING btree ("depot_id");--> statement-breakpoint
CREATE INDEX "depot_staff_admin_idx" ON "depot_staff" USING btree ("admin_id");--> statement-breakpoint
